...
class _$AuctionModelImpl with DiagnosticableTreeMixin implements _AuctionModel {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('fish', fish))
      ..add(DiagnosticsProperty('view', view))
      ..add(DiagnosticsProperty('pricestart', pricestart))
      ..add(DiagnosticsProperty('pricenow', pricenow))
      ..add(DiagnosticsProperty('insertdate', insertdate))
      ..add(DiagnosticsProperty('deletedate', deletedate))
      ..add(DiagnosticsProperty('issuccessed', issuccessed));
  }
...
abstract class _AuctionModel implements AuctionModel {
  const factory _AuctionModel(
      ...
      required final String fish,
      required final int view,
      required final int pricestart,
      required final int pricenow,
      required final String insertdate,
      required final String? deletedate,
      required final bool issuccessed}) = _$AuctionModelImpl;
